...
{
    public class DiscountNews : News
    {
        ...
        public DiscountNews() { }
        public DiscountNews(string argId, string argTypeNews, string argTitle, string argDescription, DateTime argPublicationDate, string argDurationNews)
        {
            id = argId;
            title = argTitle;
